...
parser = argparse.ArgumentParser(description='Test AGNet w KD using all frames')
# Datasets
...
# python test_baseline-all.py --root /home/yang/Documents/DataSet/person_reid_video/ -d ilidsvid --arch resnet50tp_2branch_kd --gpu 0 --resume log-mars-ap3d-debug --test_epochs 1
