...
parser = argparse.ArgumentParser(description='Train AGNet wo KD')
# Datasets
...
def train(epoch, model, criterion_xent, criterion_htri, optimizer, trainloader, use_gpu):
    ...
    for batch_idx, (vids, vids_gait, pids, _) in enumerate(trainloader):
        ...
        # forward
        outputs, features, feature_a, feature_g = model(vids, vids_gait)  #features.size()==16 2048
        ...
        loss = xent_loss + htri_loss + htri_loss_a + htri_loss_g  #or  loss = xent_loss + htri_loss
    ...
    print('Epoch{0} '
        ...
        htri_a=batch_htri_loss_a,htri_g=batch_htri_loss_g,
          acc=batch_corrects))
...
def test(model, queryloader, galleryloader, use_gpu, ranks=[1, 5, 10, 20]):
    ...
    for batch_idx, (vids,vids_gait, pids, camids) in enumerate(queryloader):
        ...
        feat_a, feat_g = model(vids, vids_gait)
...
# mars_eccv_mask duke_eccv_mask
# python train_baseline.py --root /home/yang/Documents/DataSet/person_reid_video/ -d ilidsvid --arch resnet50tp_2branch --gpu 0 --save_dir log-mars-ap3d-debug -j 0 --train_batch 8 --eval_step 1 --max_epoch 1
